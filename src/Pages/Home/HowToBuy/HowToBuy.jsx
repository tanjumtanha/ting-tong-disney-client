                    ...
                    <div className={`card animate__animated animate__fadeInLeft h-100 p-3 ${cardColors[0]}`}>
                        ...
                        <div className="card-body d-flex flex-column align-items-stretch">
                            ...
                            <p className="card-text">
                                ...
                                toy to spark their imagination and create lasting memories. Choose from a wide range of options, including
                                educational toys, interactive games, and creative playsets.
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div className={`card animate__animated animate__fadeInUp h-100 p-3 ${cardColors[1]}`}>
                        ...
                        <div className="card-body d-flex flex-column align-items-stretch">
                            ...
                            <p className="card-text">
                                ...
                                Discover interactive ways to learn and have fun with your child. From board games and puzzles to science
                                kits and art projects, there are endless opportunities to make learning enjoyable.
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div className={`card animate__animated animate__fadeInRight h-100 p-3 ${cardColors[2]}`}>
                        ...
                        <div className="card-body d-flex flex-column align-items-stretch">
                            ...
                            <p className="card-text">
                                ...
                                Share your favorite toys and discover new ones through a simple and convenient swapping process.
                            </p>
                        </div>
                    </div>
                </div>
